...
export const translations = {
  en: {
    ...
    shortTaskConflict: "This short task overlaps with '{title}'. Please adjust the time.",
    endAfterStartError: "End time should be later than start time",
    ...
    taskTitleMissing: "Task title cannot be empty",
  ...
  zh: {
    ...
    addNewTask: "添加新任务",
    shortTaskConflict: "短期任务与「{title}」时间冲突，请调整时间或改为长期任务。",
    endAfterStartError: "结束时间应该晚于开始时间",
